...
namespace RussianMentality
{
    ...
    public class Help : Microsoft.Xna.Framework.DrawableGameComponent
    {
            ...
            : base(game)
        {
            ...
            this.bgPos = bgPos;
            this.helpText =
                "Russian Mentality is an endless\nrunner game. The purpose of the\ngame is to ride for longest time";
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(textFont, helpText, textPos, Color.White);
