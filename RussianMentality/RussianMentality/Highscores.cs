...
namespace RussianMentality
{
    ...
    public class Highscores : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        {
            get { return scoresText; }
            set { scoresText = value; }
        }
        ...
        public Highscores(Game game, SpriteBatch spriteBatch,
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(textFont, scoresText, textPos, Color.White);
